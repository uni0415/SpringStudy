...
<head>
    ...
    <link rel="stylesheet" href="/gyeongun/static/css/signup.css">
            ...
            <div class="content-box">
                <div class="item-box">
                    <div class="item-group">
                        ...
                        <form action="/gyeongun/auth/signup" method="post">
                    ...
                    <div class="item-group">
                        <p class="isuser">계정이 있으신가요?<a href="/gyeongun/auth/signin">로그인</a></p>
                    </div>
                    <div class="download-img">
                        <img src="/gyeongun/static/images/download_img.PNG" alt="">
                    </div>
                </div>
            </div>
        </main>
    </section>
    <script src="/gyeongun/static/js/signup.js"></script>
</body>
</html>