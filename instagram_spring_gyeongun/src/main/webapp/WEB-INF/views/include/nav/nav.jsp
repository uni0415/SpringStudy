...
<link rel="stylesheet" href="/gyeongun/static/css/nav.css">
...
<nav class="nav-container">
	<div class="nav-bar">
		<h1 class="b-logo">
			<img src="/gyeongun/static/images/logo.png">
		</h1>
		...
		<ul class="nav-bar-items">
			...
			<li>
				<div class="profile-img-border">
					<img class="profile-img" src="/gyeongun/static/images/instagram.png">
				</div>
			</li>
		</ul>
	</div>
</nav>
<script src="/gyeongun/static/js/principal.js"></script>
<script src="/gyeongun/static/js/nav.js"></script>
